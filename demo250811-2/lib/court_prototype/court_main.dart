...
class BubbleStackScreenState extends State<BubbleStackScreen> {
  ...
  // Show silence popup when 20 messages reached
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    // Set silence timestamp and reset counter
                    setState(() {
    ...
    return Consumer<ChatController>(
      builder: (context, chatController, child) {
        return Scaffold(
          ...
          // Use AppBar with transparent background only
  ...
  Widget _buildCourtChatView(double keyboardHeight) {
    return StreamBuilder<List<CourtChatMessage>>(
      ...
      builder: (context, snapshot) {
        ...
        // Update message count and check for silence trigger every 5 messages
        WidgetsBinding.instance.addPostFrameCallback((_) {
