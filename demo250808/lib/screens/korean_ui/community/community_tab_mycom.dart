...
color: const Color(0xFF5F37CF),
  ...
  Widget _buildMyCommunityCard(double widthRatio, double heightRatio, Community community) {
    ...
    final String announcement = community.announcement ?? '아직 소개글이 없습니다 ;) ';
...
class _MyPostItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        // Community name - tappable separately
        GestureDetector(
          onTap: () async {
          ...
          child: Text(
            '$category ',
            style: const TextStyle(
              color: Color(0xFF5F37CF), // Purple color to indicate it's tappable
              fontSize: 14,
              fontWeight: FontWeight.w600,
        ...
        // Post title - tappable to go to post detail
        Expanded(
          child: GestureDetector(
            onTap: onTap, // Original post detail navigation
            child: Text(
              title,
              style: const TextStyle(
                color: Color(0xFF8E8E8E),
