...
class TransparentBackgroundVoteAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Calculate vote percentages from court session data
    final guiltyVotes = courtSession?.guiltyVotes ?? 0;
    final notGuiltyVotes = courtSession?.notGuiltyVotes ?? 0;
      ...
      child: SafeArea(
        child: Column(
          children: [
            ...
            // 2nd Row: Dynamic Scale Bar with real data
            ...
            TransparentBackgroundVoteControlRow(title: title),
          ],
        ),
      ),
    );
